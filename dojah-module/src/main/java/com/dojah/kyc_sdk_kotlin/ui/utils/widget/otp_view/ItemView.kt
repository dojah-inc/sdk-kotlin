package com.dojah.kyc_sdk_kotlin.ui.utils.widget.otp_view
...
class ItemView : FrameLayout {
    ...
    var boxBackgroundBorderColorActive: Int? = null
    ...
    fun setViewState(state: Int) {
        when (state) {
            ACTIVE -> {
                ...
                if (boxBackgroundBorderColorActive != null) {
                    this.background = MaterialShapeDrawable().apply {

                        setStrokeTint(boxBackgroundBorderColorActive!!)
                        strokeWidth = 2.toFloat()
                        setBackgroundColor(
                            ContextCompat.getColor(
                                context,
                                R.color.color_background_box
                            )
                        )
