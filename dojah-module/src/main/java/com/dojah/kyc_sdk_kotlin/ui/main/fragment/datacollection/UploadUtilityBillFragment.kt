...
import com.dojah.kyc_sdk_kotlin.databinding.FragmentUploadUtilityBillBinding
...
class UploadUtilityBillFragment : ErrorFragment() {
    private val binding by viewBinding { FragmentUploadUtilityBillBinding.bind(it) }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_upload_utility_bill, container, false)
    }
        ...
        fileContract = registerForActivityResult(ActivityResultContracts.OpenDocument()) {
            if (it != null) {
                binding.apply {
                    ...
                    val docInfo =
                        viewModel.setUtilityBillUri(requireContext(), it, isUpload = true)
                    docInfo?.also { info ->
                        if (info.docType != "pdf") {
