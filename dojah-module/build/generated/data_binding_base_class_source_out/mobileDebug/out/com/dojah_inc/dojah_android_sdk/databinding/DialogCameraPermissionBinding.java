...
public final class DialogCameraPermissionBinding implements ViewBinding {
  ...
  private DialogCameraPermissionBinding(@NonNull NestedScrollView rootView,
  ...
  @NonNull
  public static DialogCameraPermissionBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogCameraPermissionBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_camera_permission, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogCameraPermissionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogCameraPermissionBinding((NestedScrollView) rootView, btnContinue,
          howToPermit, logo, textSub, textSubtitle, textSubtitle2, textSubtitle3, textTitle,
          toolbar);
    }
