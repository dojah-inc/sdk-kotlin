...
public final class FragmentOtpEmailBinding implements ViewBinding {
  ...
  private FragmentOtpEmailBinding(@NonNull RelativeLayout rootView,
      @NonNull DojahMaterialButton btnContinue, @NonNull AppCompatTextView errorTag,
      @NonNull TextView textBvn, @NonNull TextInputLayout textInputEmail) {
  ...
  @NonNull
  public static FragmentOtpEmailBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentOtpEmailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_otp_email, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentOtpEmailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentOtpEmailBinding((RelativeLayout) rootView, btnContinue, errorTag, textBvn,
          textInputEmail);
    }
