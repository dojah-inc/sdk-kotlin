...
public final class FragmentPreviewSelfieBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPreviewSelfieBinding(@NonNull NestedScrollView rootView,
      @NonNull BlurView blurView, @NonNull LoadingButton btnContinue,
      @NonNull MaterialButton btnRetake, @NonNull ImageView cameraPreview,
      @NonNull CardView cardPreview, @NonNull AppCompatTextView errorTag,
      @NonNull AppCompatImageView innerDot, @NonNull LinearLayout processing,
      ...
      @NonNull TextView title, @NonNull VideoView videoPreview) {
  ...
  @NonNull
  public static FragmentPreviewSelfieBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPreviewSelfieBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_preview_selfie, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPreviewSelfieBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPreviewSelfieBinding((NestedScrollView) rootView, blurView, btnContinue,
          btnRetake, cameraPreview, cardPreview, errorTag, innerDot, processing, processingText,
          textSubtitle, textSubtitle2, textSubtitle3, title, videoPreview);
    }
