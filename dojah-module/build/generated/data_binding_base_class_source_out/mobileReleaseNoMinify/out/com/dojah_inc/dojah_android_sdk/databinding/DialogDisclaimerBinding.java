...
public final class DialogDisclaimerBinding implements ViewBinding {
  ...
  private DialogDisclaimerBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static DialogDisclaimerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogDisclaimerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_disclaimer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogDisclaimerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogDisclaimerBinding((RelativeLayout) rootView, btnContinue, logo, textSubtitle,
          textSubtitle2, textSubtitle3, textTitle);
    }
